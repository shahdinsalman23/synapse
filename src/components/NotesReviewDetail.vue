                ...
                <transition name="slide">
                    <div v-if="activeIndex !== null" class="mockreviewtab-detail" :style="{
                        ...
                        <div v-if="tabs[activeIndex].title === 'Comments'" class="comments-section">
                            ...
                            <ul v-if="currentQuestion && currentQuestion.comments && currentQuestion.comments.length > 0" class="comments-list">
                            ...
                            <div class="comment-input-container">
                                ...
                                <button class="send-button" @click="handleCommentSave">
                        ...
                        <div v-else-if="tabs[activeIndex].title === 'Question'" class="comments-section">
                            <div v-if="currentQuestion && currentQuestion.explanation" class="content-block mockreviewdetail-text">
    ...
    methods: {
        ...
        handleCommentSave() {
            if (this.currentQuestion && this.currentQuestion.id) {
                this.commentsave(this.currentQuestion.id);
            }
        },
        addComment() {
